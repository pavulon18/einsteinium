...
# use: qmake "RELEASE=1"
contains(RELEASE, 1) {
    # Mac: compile for altered compatibility (10.8 64 bit)
    macx:QMAKE_CXXFLAGS += -mmacosx-version-min=10.8
    macx:QMAKE_CFLAGS += -mmacosx-version-min=10.8
    macx:QMAKE_OBJECTIVE_CFLAGS += -mmacosx-version-min=10.8
    !win32:!macx {
...
macx:ICON = src/qt/res/icons/einsteinium.icns
